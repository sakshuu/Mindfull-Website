...
//           </div>
//               </div>
//               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.7002495215734!2d73.87624!3d18.497232!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdb01c710d98309%3A0x2b9c011d3f3844a9!2sMindful%20Being!5e0!3m2!1sen!2sin!4v1746273230912!5m2!1sen!2sin" style={{width:'99vw', height:'70vh', border:'0px'}} referrerpolicy="no-referrer-when-downgrade"></iframe>
...
//           {faqs.map((faq, index) => (
//             <div   key={index} className={`border border-zinc-800 rounded-2xl p-6 ${faq.isOpen ? "bg-blue-600" : ""}`} >
//               <div className="flex justify-between items-center" style={{backgroundColor:'3255A4'}}>
//                 <h3 className="text-sm font-medium">{faq.question}</h3>
//                 <button
//                   onClick={() => toggleFAQ(index)}
//                   className="bg-zinc-800 rounded-full p-1 flex items-center justify-center"
//                 >
