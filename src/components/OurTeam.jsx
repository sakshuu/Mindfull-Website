...
//       thought:
//         "It's not just about data or campaigns; it's about understanding people and giving them what they truly need.",
//     },
//     {
//       id: "6",
...
//       thought:
//         "In the digital world, content is the voice of your brand.",
//     },
//     {
//       id: "11",
...
//             <h2 className="text-2xl font-semibold pt-10 ml-20 text-left text-gray-400" sty>Our Team</h2>
    ...
    <div className="h-[100vh] w-[99vw] text-white">
      <div className="relative">
         <div className="w-[100%] h-[97vh] flex flex-col lg:flex-row r-8">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <motion.h2
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 0.3, duration: 0.5 }}
                    style={{ textTransform:'uppercase', fontFamily:'Spartan'}}>
                    {selectedMember.fullName}
                  </motion.h2>
                  <motion.div
                    className="flex items-center justify-center gap-2 mb-6"
                  ...
                  >
                    <div className="flex  justify-between gap-4 items-baseline">
                      <img src={headingcommastart} width={17} alt="" /> 
                    <p className="text-sm md:text-base max-w-md text-center" style={{ fontFamily:'Spartan'}}>
                      {selectedMember.thought}
                    </p>
                   <img className="-mt-16" src={headingcommaend} width={17} alt="" />
                    </div>
          ...
          <div className="w-[50%]  flex justify-start items-start mr-5">
            <AnimatePresence mode="wait">
              <motion.div
                key={selectedMember.id}
                initial={{ opacity: 0, scale: 0.9 }}
          ...
          >
            {teamAll.map((member, index) => (
              ...
              >
                ...
                <div className="text-center mt-2" >
                  <span
                    className={`text-base text-gray-500 font-semibold text-center ${
                      selectedMember.id === member.id ? `text-lg text-white font-medium text-center` : ""
                  ...
                  <div
                    className={`text-xs text-gray-500 text-center ${
                      selectedMember.id === member.id ? `font-semibold text-white text-center` : ""
                    }`}
                    style={{ lineHeight: "0.4rem" , fontFamily:'Albert Sans'}}
                  >
                    {member.roll}
                  </div>
                </div>
