...
// //   return (
// // <div className="h-[100vh] w-[99vw] text-white py-8 ">
// // <div className="relative">
// //           <div className="  w-[100%] h-[80vh] flex flex-col lg:flex-row px-10 items-center lg:items-start justify-between gap-8">
// //             <div className="w-[50%] h-full  bg-red-300  ">
// //               {/* <div> */}
// //               <h2 className="text-lg font-semibold mb-4 text-left">Our Team</h2>
// //               <div className="bg-slate-700 py-10 flex flex-col text-center items-center  ">
...
// //                     <p className="text-sm md:text-base max-w-md  text-center"> <img src={headingcommastart} width={17} alt="" />{selectedMember.thought}                     </p> <img className="-mt-16" src={headingcommaend} width={17} alt="" />
...
// //             </div>
// //           </div>
// //           <div className="w-full  bg-white/30 backdrop-blur-md   mt-2 absolute -bottom-10">
// //             <div
// //               ref={containerRef}
...
// //                   className="snap-center flex-shrink-0 cursor-pointer transition-all duration-300 transform hover:scale-105"  >
// //                   <div
// //                     className={`relative rounded-full ml-6  overflow-hidden w-28 h-28   p-1 ${
// //                       selectedMember.id === member.id ? `${member.bgColor}` : ""
// //                     }`}
// //                   >
// //                     <img
// //                       src={member.profile}
...
//   const [selectedMember, setSelectedMember] = useState(teamAll[0])
//   const [currentIndex, setCurrentIndex] = useState(0)
//   const [profileImages, setProfileImages] = useState(teamAll.map(member => member.profile))
//   const containerRef = useRef(null)
...
//     setCurrentIndex(newIndex)
//     setSelectedMember(teamAll[newIndex])
//     // Reset all profile images to default on navigation
//     setProfileImages(teamAll.map(member => member.profile))
//   }
...
//           </div>
//         </div>
//         <div className="w-full bg-black/40 backdrop-blur-md mt-2 absolute -bottom-10">
//           <div
//             ref={containerRef}
//             className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide gap-4 py-4"
//             style={{ scrollBehavior: "smooth", touchAction: "pan-x" }}
...
//                 onClick={() => handleMemberClick(member, index)}
//                 // className="snap-center flex-shrink-0 cursor-pointer transition-all duration-300 transform hover:scale-105"
//                 className="snap-center flex-shrink-0 cursor-pointer transition-all duration-300 transform"
//               >
//                 <div
//                   className={`relative rounded-full ml-6 overflow-hidden w-28 pt-1 h-28 p-1 ${
//                     selectedMember.id === member.id ? `h-32 w-32 -mt-4 shadow-lg` : ""
//                   } shadow-lg`} // Added shadow to profile images
//                 >
//                   <img
...
//                   className={`relative rounded-full ml-6 overflow-hidden w-28 pt-1 h-28 p-1 ${
//                     selectedMember.id === member.id ? `h-32 w-32 -mt-4 shadow-lg` : ""
//                   } ${profileImages[index] === member.colorprofile ? "shadow-[0_0_15px_5px_rgba(255,255,255,0.7)]" : "shadow-lg"}`} // White shadow for colored image
//                 >
//                   <img
//                     src={profileImages[index]}
//                     alt={member.name}
...
//                 key={member.id}
//                 onClick={() => handleMemberClick(member, index)}
//                 className="snap-center pt-2 flex-shrink-0 cursor-pointer transition-all duration-300 transform"
//               >
//                 <div
//                   className={`relative rounded-full ml-6 overflow-hidden w-28 h-28  ${
//                     selectedMember.id === member.id ? `h-32 w-32 -mt-4 shadow-[0_0_15px_5px_rgba(255,255,255,0.7)]` : ""
//                   } ${profileImages[index] === member.colorprofile ? "shadow-[0_0_15px_5px_rgba(255,255,255,0.7)]" : "shadow-[0_0_5px_1px_rgba(255,255,255,0.3)]"}`} // Adjusted shadow and removed padding
//                 >
//                   <img
//                     src={profileImages[index]}
//                     alt={member.name}
...
//       <div className="relative">
//         <div className="w-[100%] h-[90vh] flex flex-col lg:flex-row px-10 items-center lg:items-start justify-between gap-8">
//           <div className="w-[50%] h-full bg-red-300">
//             <h2 className="text-lg font-semibold my-[12%] mb-4 text-left">Our Team</h2>
//             <div className="bg-slate-700 py-10  flex flex-col text-center items-center">
//               <AnimatePresence mode="wait">
//                 <motion.div
//                   key={selectedMember.id}
...
//                 <div
//                   className={`relative rounded-full ml-6 overflow-hidden w-28 h-28 p-0 ${
//                     selectedMember.id === member.id ? `h-32 w-32 -mt-4 shadow-[0_0_15px_5px_rgba(255,255,255,0.7)]` : ""
//                   } ${profileImages[index] === member.colorprofile ? "shadow-[0_0_15px_5px_rgba(255,255,255,0.7)]" : "shadow-[0_0_15px_5px-rgba(255,255,255,0.7)]"}`}
//                 >
//                   <img
//                     src={profileImages[index]}
//                     alt={member.name}
