...
//                 </li>
//                 <li>
//                   <div className='bg-gray-500 text-white px-2 rounded-xl text-xs font-extralight m-1 py-1 w-auto'>Comming soon</div>
//                   <NavLink>
//                     Blogs
//                   </NavLink>
//                 </li>
...
const ContactusFooter = () => {
  ...
  // Items that should show "Coming soon" on hover
  const comingSoonItems = ['blogs', 'testimonials', 'privacy', 'terms'];
          ...
          <div className="space-y-8  col-span-2 pl-20">
            ...
            <nav>
              <ul className="flex flex-wrap justify-around">
                ...
                >
                  {hoveredItem === 'blogs' && (
                    <div className="absolute -top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs p-1 px-2 rounded whitespace-nowrap">
                      Coming soon
                    </div>
                  )}
                  <NavLink to="#">
            ...
            <div className="w-[95%] px-5 py-3">
              <div className="flex flex-col w-[100%] flex-wrap md:flex-col  justify-between xl:flex-row gap-4 mt-4">
                ...
                <div className="relative w-[45%]">
                  ...
                  {showCopied && (
                    <div className="absolute -top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs w-36 p-2 rounded">
                      Copied to clipboard!
                    </div>
                  )}
                </div>
